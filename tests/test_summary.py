...
def test_generate_summary_returns_non_empty_string():
    ...
    mock_client.create_message.return_value = "This is a notice of competition. It covers scholarships and accommodation."
...
def test_generate_summary_calls_api_once():
    ...
    mock_client = MagicMock()
    mock_client.create_message.return_value = "Summary sentence one. Summary sentence two."
...
def test_generate_summary_passes_content_to_api():
    ...
    mock_client = MagicMock()
    mock_client.create_message.return_value = "Result summary."
