...
from docstruct.domain.models.heading import DocumentMetadata, HeadingEntry, TOCBoundary
...
class ExtractionResult:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "heading_map": [entry.to_dict() for entry in self.heading_map],
            "summary": self.summary,
            "metadata": self.metadata.to_dict(),
            "toc_boundaries": self.toc_boundaries.to_dict(),
            "processing_log": [item.to_dict() for item in self.processing_log],
